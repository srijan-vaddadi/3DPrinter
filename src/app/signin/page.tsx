...
export default function SignInPage() {
  ...
  async function handleCredentialsLogin(e: React.FormEvent) {
    ...
    if (result?.error) {
      setError('Invalid email or password. Demo: use any email with password "password"');
    } else {
      router.push('/');
      router.refresh();
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-dark to-[#2d1b69] px-4">
      <div className="bg-white rounded-2xl p-12 shadow-2xl w-full max-w-md">
        ...
        <p className="text-gray text-center mb-8">Sign in to your account to continue</p>
        ...
        <div className="space-y-3 mb-6">
          ...
          >
            ...
            <span className="text-dark font-medium">Continue with Google</span>
          </button>
          ...
          >
            ...
            <span className="text-dark font-medium">Continue with GitHub</span>
          </button>
        </div>
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-sm text-gray">or sign in with email</span>
          <div className="flex-1 h-px bg-gray-200" />
        </div>
